alter table sms.phone_number_requests add column daily_contact_limit integer DEFAULT 200 NOT NULL;
alter table sms.phone_number_requests add column throughput_interval interval DEFAULT '00:01:00'::interval NOT NULL;
alter table sms.phone_number_requests add column throughput_limit integer DEFAULT 6 NOT NULL;

alter table sms.all_phone_numbers add column daily_contact_limit integer DEFAULT 200 NOT NULL;
alter table sms.all_phone_numbers add column throughput_interval interval DEFAULT '00:01:00'::interval NOT NULL;
alter table sms.all_phone_numbers add column throughput_limit integer DEFAULT 6 NOT NULL;
alter table sms.all_phone_numbers add CONSTRAINT only_one_minute_interval CHECK ((throughput_interval = '00:01:00'::interval));

alter table sms.fresh_phone_commitments add column daily_contact_limit integer DEFAULT 200 NOT NULL;
alter table sms.fresh_phone_commitments add column throughput_interval interval DEFAULT '00:01:00'::interval NOT NULL;
alter table sms.fresh_phone_commitments add column throughput_limit integer DEFAULT 6 NOT NULL;

DROP VIEW if exists sms.pending_number_request_capacity;
...
DROP VIEW if exists sms.phone_numbers;
