-- Revert public.add_job_with_sending_account_and_profile_info
-- ------------------------------------------------------------
...
-- Revert lookup.tg__access__fulfill
-- ------------------------------------------------------------
...
-- Revert public.attach_10dlc_campaign_to_profile
-- ------------------------------------------------------------
...
-- Revert public.trigger_job_with_profile_info
-- ------------------------------------------------------------
...
begin
  ...
  perform assemble_worker.add_job(TG_ARGV[0], v_job, null, 8);
  return NEW;
end;
$$;


-- Revert public.trigger_job_with_sending_account_info
-- ------------------------------------------------------------
...
-- Revert sms.queue_find_suitable_area_codes_refresh
-- ------------------------------------------------------------
...
-- Revert sms.refresh_area_code_capacity_estimates
-- ------------------------------------------------------------
...
-- Revert sms.refresh_one_area_code_capacity
-- ------------------------------------------------------------
...
-- Revert sms.tg__trigger_process_message
-- ------------------------------------------------------------
