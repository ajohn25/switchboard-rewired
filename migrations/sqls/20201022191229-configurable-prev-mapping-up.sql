...
CREATE FUNCTION sms.process_message(
  message sms.outbound_messages,
  check_old_messages boolean default false,
  prev_mapping_validity_interval interval default null
